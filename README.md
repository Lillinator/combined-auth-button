...
This Discouese theme component replaces the existing `Log In` button with a combined `Sign Up / Log In` button in mobile view so it is less confusing for new users. Admins can also specify their own custom button text.

Default without component: <br/>
...
With component installed and `Hide login button icon` enabled: <br/>
...
With component installed & cusomtized button text: <br />
